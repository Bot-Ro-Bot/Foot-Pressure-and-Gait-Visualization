...
boolean flagAngleSet=true;
boolean flagGyroCalib=false;
...
//Serial.print("\n\nSample Rate=");Serial.println(sampleRate);
 ...
 /* if(flagAngleSet==true){               //if acceleromter is calibrated right...most reliable data ko laagi
  gyroRoll=accRoll;
  gyroPitch= accPitch;
...
void IMU:: toProcessing(){
 ...
 //Serial.print(gyroYaw); Serial.print(",");             //rimesh ji ko tarika....hola
